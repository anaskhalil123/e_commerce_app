...
class FireStoreCotroller {
  ...
  Future<DocumentSnapshot<Map<String, dynamic>>> getMyInformation(
  ...
  Future<bool> updateUser({required Userm user}) async {
    return await _firebaseFirestore
        .collection('Users')
        .doc(user.id)
        .update(user.toMap())
  ...
  Future<bool> addToOrders(
      {required OrderProduct orderProduct, required String path}) async {
    // final _auth = FirebaseAuth.instance;
    // var hashmap =HashMap<String, dynamic>();
    //  hashmap['id'] = path;
    // hashmap['quantity'] = quantity;
  ...
  Future<bool> isOrdered(
      {required String id, required Purchase purchase}) async {
    final _auth = FirebaseAuth.instance;
    // var hashmap =HashMap<String, dynamic>();
    //  hashmap['id'] = path;
    // hashmap['quantity'] = quantity;
